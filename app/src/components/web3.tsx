...
export async function upload(imageFile:any) {
  const cid = await web3storage.put([imageFile]);
  // console.log(cid);
  return cid;
}

export async function retrieve(cid : any) {
  const res:any = await web3storage.get(cid);
...
export async function Download(cid : any) {
  // console.log(cid);
